...
CRONJOBS = [
    # 每5分钟执行一次生成主页静态文件
    ('*/5 * * * *', 'advertising.adver.generate_static_index_html', '>> /home/thedevilsgrave/Desktop/meiduo_project/meiduo/meiduo_mall/logs/crontab.log')
]
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.0.104:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
